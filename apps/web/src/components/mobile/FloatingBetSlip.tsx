          ...
          {showConfirmation && lastPlacedBet ? (
            <div className="p-4 space-y-3">
              <div className="flex flex-col items-center py-3">
                ...
                <h3 className="font-bold text-slate-900 dark:text-white text-base">Đặt cược thành công!</h3>
              </div>
              ...
              <div className="rounded-lg bg-slate-50 dark:bg-slate-800 p-3 space-y-2 text-sm">
                ...
                <div className="border-t border-slate-200 dark:border-slate-700 pt-2 mt-2 space-y-1">
                  <div className="flex justify-between">
                    <span className="text-slate-500 dark:text-slate-400">Tiền cược</span>
                    <span className="font-medium text-slate-900 dark:text-white">{new Intl.NumberFormat('vi-VN').format(lastPlacedBet.stake)} ₫</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500 dark:text-slate-400">Tiềm năng thắng</span>
                    <span className="font-bold text-emerald-600 dark:text-emerald-400">{new Intl.NumberFormat('vi-VN').format(Math.round(lastPlacedBet.potentialWin))} ₫</span>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              <div className="p-3 border-t border-slate-200 dark:border-slate-700 space-y-3">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={stake > 0 ? formatCurrency(stake) : ''}
                ...
                <button
                  ...
                  disabled={stake <= 0 || isPlacing || items.some((i) => !i.oddsId)}
                  className={cn(
