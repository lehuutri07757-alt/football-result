...
import { Loader2, Eye, EyeOff, Trophy, ArrowLeft } from 'lucide-react';
      ...
      <nav className="absolute top-0 w-full border-b border-slate-200 bg-white/80 dark:border-white/5 dark:bg-slate-950/80 backdrop-blur-md z-10">
        <div className="container mx-auto flex items-center justify-between px-4 py-4">
          ...
          <div className="flex items-center gap-4">
            <ThemeToggle />
            <Link href="/" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white flex items-center gap-1">
              <ArrowLeft size={16} />
              Back to Home
            </Link>
          </div>
