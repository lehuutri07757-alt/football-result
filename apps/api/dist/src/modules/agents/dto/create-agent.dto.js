...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'agent001' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'agent@example.com' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Parent agent ID (for sub-agents)' }),
    (0, class_validator_1.IsUUID)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateAgentDto.prototype, "parentId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 5.00, description: 'Commission rate percentage (0-100)' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    (0, class_validator_1.Max)(100),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreateAgentDto.prototype, "commissionRate", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Agent betting limits configuration' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Object)
], CreateAgentDto.prototype, "bettingLimits", void 0);
